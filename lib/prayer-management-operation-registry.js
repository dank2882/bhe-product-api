...
const PRAYER_OPERATIONS = Object.freeze([
  ...
  define("createPrayer", "command", "Create an encrypted private prayer with an optional daily, weekly, monthly, interval, or one-date schedule.", ["listId", "title", "prayerText"], ["privateContext", "tags", "people", "topics", "schedule", "presentation", "source", "sourceRef", "prayerId"], service.createPrayer),
...
const CATALOG_VERSION = "2026-08-24";
