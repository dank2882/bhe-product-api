...
function assertHierarchyChangeAllowed(next, existing, deps) {
  if (existing) assertCanUpdateTaskRecord(existing, {}, deps, "project");
...
async function updateProject(input = {}, deps = {}) {
  ...
  if (hierarchyChanged && (departmentChanged || teamChanged)) throw hierarchyError("Move the project separately from changing its team or department");
