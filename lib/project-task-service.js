...
async function updateRoutine(input = {}, deps = {}) {
  ...
  if (nextRoutine.visibility === "branch") throw hierarchyError("Routines cannot use project branch sharing");
...
for (const name of ["createProject", "listProjects", "getProject", "updateProject", "createTask", "getTask", "listTasks", "updateTask", "addTaskNote", "listTaskNotes", "buildDailyReview", "buildDailyBrief", "buildLeadershipBrief", "respondToAssignment", "restoreTaskRecord"]) {
