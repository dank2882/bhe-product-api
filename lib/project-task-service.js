...
async function createProject(input = {}, deps = {}) {
  ...
  if (collaborationPolicy && (collaborationPolicy !== "editor_archive_creator_delete" || input.visibility !== "branch")) throw hierarchyError("The collaboration policy requires branch visibility");
...
async function updateProject(input = {}, deps = {}) {
  ...
  if (Object.hasOwn(changes, "collaborationPolicy")) {
    throw createProjectTaskError("Collaboration policy is fixed when the team area is created", 403, {}, "project_sharing_denied");
  }
