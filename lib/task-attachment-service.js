...
async function getTaskAttachmentDownload(input = {}, deps = {}) {
  ...
  // so chat can display the private image without forcing a file download.
  let preview;
  ...
  return {
    ...
    ...(preview ? { preview, guidance: "Show preview.url as an inline Markdown image, followed by the download link. Links expire after 15 minutes; retrieve fresh links when needed. Do not substitute a download-only reply for a requested photo preview." } : {})
  };
}
