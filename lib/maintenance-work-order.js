...
const WORK_ORDER_TEMPLATE = Object.freeze({
  ...
  guidance: "Draft only. Populate from the current task and Shawna's instructions; never include internal task notes automatically or invent scope, costs, deadlines or commitments. Email may be addressed to any valid email address without recipient registration or consent. Exact outgoing draft approval remains required before sending."
});
