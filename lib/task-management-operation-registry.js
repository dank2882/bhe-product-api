...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({
    ...
    argumentGuidance: "Use parentProjectId for direct children (empty string lists roots), or ancestorProjectId for a whole branch including its root. Follow nextCursor while hasMore is true. Restricted branches inherit ancestor grants; legacy projects retain existing access.",
