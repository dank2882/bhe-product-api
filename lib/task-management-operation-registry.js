...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({
    ...
    argumentGuidance: "For photos display preview.url as an inline Markdown image and also offer download.url. Use returned URLs only before expiration; never store a signed URL on the task.",
