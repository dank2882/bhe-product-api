...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({
    ...
    optional: ["status", "lifeArea", "department", "teamId", "priority", "targetOnOrBefore", "query", "limit", "cursor"],
  ...
  defineOperation({
    ...
    required: ["name"],
    optional: ["projectId", "outcome", "lifeArea", "department", "teamId", "status", "priority", "targetDate", "requestedBy", "leadSub", "leadName", "leadEmail", "health", "healthNote", "nextReviewDate", "milestones", "dependencies", "notes", "visibility"],
