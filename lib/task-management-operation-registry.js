...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({
    ...
    required: ["name"],
    optional: ["projectId", "outcome", "lifeArea", "status", "priority", "targetDate", "requestedBy", "notes"],
  ...
  defineOperation({
    ...
    required: ["title"],
    optional: ["taskId", "projectId", "lifeArea", "status", "priority", "dueDate", "scheduledDate", "scheduledTime", "timeWindow", "waitingOn", "followUpDate", "requestedBy", "assignedTo", "context", "notes"],
  ...
  defineOperation({
    name: "addTaskNote",
    mode: "command",
    summary: "Append a dated note from Dan or Sarah to one task without overwriting prior notes.",
  ...
  defineOperation({
    ...
    required: ["title"],
    optional: ["routineId", "lifeArea", "status", "recurrence", "recurrenceNotes", "preferredTime", "assignedTo", "requestedBy", "notes"],
