...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({
    ...
    optional: ["status", "lifeArea", "department", "teamId", "priority", "targetOnOrBefore", "query", "limit"],
  ...
  defineOperation({
    ...
    optional: ["status", "priority", "projectId", "lifeArea", "department", "teamId", "requestedBy", "assignedTo", "assignedToSub", "sourceMessageId", "workOnDate", "workOnOnOrBefore", "query", "dueBefore", "dueOnOrBefore", "followUpOnOrBefore", "limit", "detailLevel"],
