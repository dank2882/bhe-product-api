...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  defineOperation({ name: "listMaintenanceBoard", mode: "query", required: [], optional: ["includeArchived", "limit", "cursor"], summary: "Return the Maintenance table in its exact ten-column format, grouped by building and area.", handler: maintenance.listMaintenanceBoard }),
  ...
  defineOperation({ name: "listMaintenanceRoutines", mode: "query", required: [], optional: ["includeArchived"], summary: "Read the complete authorized recurring Maintenance duties.", handler: maintenance.listMaintenanceRoutines }),
