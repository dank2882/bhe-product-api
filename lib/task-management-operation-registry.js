...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({
    ...
    required: ["name"],
    optional: ["projectId", "parentProjectId", "branchMembers", "outcome", "lifeArea", "department", "teamId", "status", "priority", "targetDate", "requestedBy", "leadSub", "leadName", "leadEmail", "health", "healthNote", "nextReviewDate", "milestones", "dependencies", "notes", "visibility"],
