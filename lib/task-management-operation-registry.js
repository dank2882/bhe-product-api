...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  defineOperation({ name: "listMaintenanceBoard", mode: "query", required: [], optional: ["includeArchived", "limit", "cursor", "building", "area", "status", "priority", "assignedTo", "unassigned", "query", "reference", "detailLevel"], summary: "Return a ready-to-display working table in chat with ten columns, stable references, building/area grouping, counts and filters. Display markdown directly; compact notes by default. Use existing versioned task commands for requested changes and refresh after saving. Do not export a spreadsheet unless explicitly requested.", handler: maintenance.listMaintenanceBoard }),
