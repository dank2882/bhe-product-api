...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({ name: "listMaintenanceInbox", mode: "query", summary: "Maintenance communications: listInbox. Requires Maintenance manager permission; drafts never send. Approval requires current version and content digest. See getMaintenanceMessagingGuide.", optional: ["messageId", "reporterId", "changes", "expectedVersion", "draftId", "contentDigest", "channel", "recipient", "body", "subject", "taskId", "decision", "mediaIds", "mediaId", "cursor", "limit", "requestKey"], handler: (input, deps) => maintenance.maintenanceMessaging({ ...input, action: "listInbox" }, deps) }),
  ...
  defineOperation({ name: "reviewMaintenanceMessage", mode: "command", summary: "Maintenance communications: reviewMessage. Requires Maintenance manager permission; drafts never send. Approval requires current version and content digest. See getMaintenanceMessagingGuide.", optional: ["messageId", "reporterId", "changes", "expectedVersion", "draftId", "contentDigest", "channel", "recipient", "body", "subject", "taskId", "decision", "mediaIds", "mediaId", "cursor", "limit", "requestKey"], handler: (input, deps) => maintenance.maintenanceMessaging({ ...input, action: "reviewMessage" }, deps) }),
  defineOperation({ name: "draftMaintenanceMessage", mode: "command", summary: "Maintenance communications: draftMessage. Requires Maintenance manager permission; drafts never send. Approval requires current version and content digest. See getMaintenanceMessagingGuide.", optional: ["messageId", "reporterId", "changes", "expectedVersion", "draftId", "contentDigest", "channel", "recipient", "body", "subject", "taskId", "decision", "mediaIds", "mediaId", "cursor", "limit", "requestKey"], handler: (input, deps) => maintenance.maintenanceMessaging({ ...input, action: "draftMessage" }, deps) }),
