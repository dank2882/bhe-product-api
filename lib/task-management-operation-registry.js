...
const TASK_MANAGEMENT_OPERATIONS = Object.freeze([
  ...
  defineOperation({
    ...
    optional: ["status", "priority", "projectId", "lifeArea", "department", "requestedBy", "assignedTo", "assignedToSub", "sourceMessageId", "workOnDate", "workOnOnOrBefore", "query", "dueBefore", "dueOnOrBefore", "followUpOnOrBefore", "limit"],
    exampleArguments: { assignedTo: "Dan", department: "facsimiles", workOnDate: "2026-07-22", limit: 25 },
    argumentGuidance: "Departments are optional and use facsimiles, displays, retail, or education. Sermon identity, preparation, readiness, and preaching dates belong in Sermon Workspace and should not be represented as ordinary tasks.",
    handler: listTasks
  }),
  defineOperation({
    name: "getTask",
